  ...
  return (
    <div>
      ...
      <div id="projects" className="mx-[5%]">
        ...
        <ProjectCard 
            title="Inside Edit"
            desc="Project is currently in progress - revamping the website for a New York based interior designer. Client-approved design mockups were created in Figma. The site is built with React.js using the Next.js framework, styled with Tailwind CSS, and deployed via Vercel."
